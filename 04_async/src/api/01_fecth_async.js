/*
    자바스크립트로 사용하면 필요할 때 서버에 네트워크 요청을 보내고 새로운 정ㄹ보를 받아올 수 있다.
    ...
    반환받은 promise가 내장클래스 response 인스턴스와 함께 이행 상태가 된다.
    ...
    https://jsoinplaceholder.typeicode.com
*/

async function callAPi(){
    const promise = fetch('https://jsoinplaceholder.typeicode.com')
